...
Tags: gutenberg, blocks, editor, template, pattern
...
Enhance your Gutenberg experience with 50+ unique blocks. Add power to the block editor using our easy-to-use blocks, which are designed to make your next WordPress page or post design easier and prettier than ever before.
...
No extra resources; Enable and disable individual blocks to make your page load faster and smoother with instant live editing, keeping your Gutenberg site lightweight.

###🚀 ASSET REGENERATION & RESPONSIVENESS
Keep your website’s loading speed fast and secure against heavy scripts and CSS files with the Asset Regeneration feature. And control each block's responsiveness individually to make your website user-friendly for all devices.
...
Explore and get access to 2,500+ ready Gutenberg templates from Templately. You can easily customize the fully responsive templates, upload the designs to the cloud to use again later, and collaborate with your team with ease. You will find a wide variety of stunning Gutenberg website or web page templates in any niche such as Blog & Magazine, eCommerce, etc.
...
- **[Multicolumn Pricing Table (PRO)](https://essential-blocks.com/demo/multicolumn-pricing-table)** - Use a variety of table layouts to showcase price comparisons and mention features, display icons, and so on.
- **[Stacked Cards (PRO)](https://essential-blocks.com/demo/stacked-cards)** - Easily make your stacked cards sticky in place and provide users with an interactive experience when they scroll through your website.
- **[Testimonial Slider (PRO)](https://essential-blocks.com/demo/testimonial-slider)** -  Display engaging and credible customer testimonials, reviews and ratings in a sleek slider to build trust
- **[Offcanvas (PRO)](https://essential-blocks.com/demo/offcanvas/)** - Showcase a sidebar menu on your website and grab visitors’ attention with various stunning transitions & effects.


## 📄 SUPPORT & DOCUMENTATION
- For any questions, visit the **[Plugin’s Forum](https://wordpress.org/support/plugin/essential-blocks/)**.
- Find step-by-step guide on every block from our **[detailed documentation](https://essential-blocks.com/docs/)** & **[Youtube Channel](https://www.youtube.com/c/WPDeveloperNet)**.
- For more information and details about features, check out our website **[Essential Blocks for Gutenberg](https://essential-blocks.com/)**.
